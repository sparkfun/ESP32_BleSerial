...
void BleSerial::begin(const char* name, const int led_pin)
{
...
void BleSerial::begin(const char* name, const char* service_uuid, const char* rx_uuid, const char* tx_uuid,
                      const int led_pin)
{
...
size_t BleSerial::write(uint8_t byte)
{
	...
	if (transmitBufferLength == maxBleTransferSize())
	{
		flush();
	}
	return 1;
...
void BleSerial::flush()
{
	...
	{
		txCharacteristic->setValue(transmitBuffer, transmitBufferLength);
